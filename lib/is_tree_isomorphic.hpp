...
inline bool is_tree_isomorphic_rooted(Map &k, const Graph &g1, const Graph &g2, i32 r1, i32 r2) {
...
inline bool is_tree_isomorphic_rooted(const Graph &g1, const Graph &g2, i32 r1, i32 r2) {
    std::map<std::vector<i32>, i32> k;
    return is_tree_isomorphic_rooted(k, g1, g2, r1, r2);
}

template <typename Map, typename Graph>
inline bool is_tree_isomorphic_rooted(Map &k, const Graph &g1, const Graph &g2) {
    return is_tree_isomorphic_rooted(k, g1, g2, 0, 0);
}

template <typename Graph>
inline bool is_tree_isomorphic_rooted(const Graph &g1, const Graph &g2) {
    return is_tree_isomorphic_rooted(g1, g2, 0, 0);
}

template <typename Map, typename Graph>
inline bool is_tree_isomorphic_unrooted(Map &k, const Graph &g1, const Graph &g2, const std::vector<i32> &c1,
...
template <typename Graph>
inline bool is_tree_isomorphic_unrooted(const Graph &g1, const Graph &g2, const std::vector<i32> &c1,
                                        const std::vector<i32> &c2) {
    std::map<std::vector<i32>, i32> k;
...
template <typename Map, typename Graph>
inline bool is_tree_isomorphic_unrooted(Map &k, const Graph &g1, const Graph &g2) {
...
template <typename Graph>
inline bool is_tree_isomorphic_unrooted(const Graph &g1, const Graph &g2) {
    std::map<std::vector<i32>, i32> k;
